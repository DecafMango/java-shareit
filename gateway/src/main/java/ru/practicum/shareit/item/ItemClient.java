...
public class ItemClient extends BaseClient {
    ...
    public ResponseEntity<Object> createComment(long commentatorId, long itemId, CommentDto commentDto) {
        Map<String, Object> parameters = Map.of(
                "itemId", itemId
        );
        return post("/{itemId}/comment", commentatorId, parameters, commentDto);
    }

    public ResponseEntity<Object> updateItem(long userId, long itemId, ItemDto itemDto) {
        ItemValidator.checkNotNullFields(itemDto);
        Map<String, Object> parameters = Map.of(
                "itemId", itemId
        );
